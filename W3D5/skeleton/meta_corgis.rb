...
class MetaCorgiSnacks
  ...
  # star if tastiness level is above 30, snack type, snack description, tastiness level
  # def method_missing(name, *args)
  #   # Your code goes here...
  #
  #   # is this necessary? Is it passed in as a symbol? Probably!
  #   name = name.to_s
  #   info_text = "get_#{name}_info"
  #   info = @snack_box.send(info_text, @box_id)
  #   tasty_text = "get_#{name}_tastiness"
  #   tastiness = @snack_box.send(tasty_text, @box_id)
